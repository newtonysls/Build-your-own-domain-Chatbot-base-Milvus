...
|------------------|----------------|------------|------------------------------------------------------------------------------------------------------------------------------------------|
|功能              |算法            |工程        |备注                                                                                                                                      |
|知识点chunk       |✅              |❌          |对知识点进行chunk，然后映射向量                                                                                                           |
|辅助检索知识库    |✅              |❌          |摘要、标题等其余信息辅助检索                                                                                                              |
|有言架构层级知识库|✅              |❌          |包含有言架构知识库[NLP_研发周报2023-2024](https://rsjqcmnt5p.feishu.cn/docx/SBDFdsRj4oQLRwxPyWucy5W6nZe#share-HKaydUNakoulqoxAywbcFnu8nEc)|
|query改写-未微调  |✅              |✅          |和问答模型同一个模型                                                                                                                      |
|query改写-微调    |✅              |❌          |和微调过的问答模型为同一模型                                                                                                              |
|BM25检索          |✅              |❌          |自研多轮bm25检索算法                                                                                                                      |
|微调向量化模型    |✅              |✅          |微调过的检索模型-只用于有言                                                                                                               |
|重排模型          |✅              |✅          |通用重排模型                                                                                                                              |
|微调问答模型      |✅              |❌          |微调后的问答模型，只适用于有言                                                                                                            |
|终端效果          |**93.31**%（7b）|86.9%（14b）|                                                                                                                                          |
...
|                                                                                                                                        |
|----------------------------------------------------------------------------------------------------------------------------------------|
|JSON功能描述：为视频添加蒙版操作功能路径：{  "一级功能":"轨道轴",  "二级功能":"视频片段",  "三级功能":"工具栏",  "四级功能":"添加蒙版",}|
...
|                                                                                                                                                                                                                                                                                                                                                                                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|JSON功能描述：为视频添加蒙版操作功能路径：{  "一级功能":"轨道轴",  "二级功能":"视频片段",  "三级功能":"工具栏",  "四级功能":"添加蒙版",}功能描述：为视频添加文字操作功能路径：{  "一级功能":"轨道轴",  "二级功能":"视频片段",  "三级功能":"工具栏",  "四级功能":"文字",}功能描述：调节视频音量功能路径：{  "一级功能":"轨道轴",  "二级功能":"视频片段",  "三级功能":"工具栏",  "四级功能":"音量调节",}|

  那对三级功能**“工具栏”**进行摘要总结得到的概要上层meta知识点为
|                                                                                                                                                     |
|-----------------------------------------------------------------------------------------------------------------------------------------------------|
|JSON功能描述：使用工具栏对视频片段进行编辑，包含蒙版、文字和音量等操作功能路径：{  "一级功能":"轨道轴",  "二级功能":"视频片段",  "三级功能":"工具栏"}|
...
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
|JSON--任务--在多轮对话任务中，对用户输入的问题进行准确理解是非常重要的。你需要完成在多轮对话中Query改写的任务，请结合对话历史上下文内容准确识别用户意图，对当前Query进行省略补全，让query更清晰和完整。--对话历史上下文说明--《描述该对话发生在什么应用场景，能够是的LLM对query的补全更加准确》--要求--1.首先判断query是否需要进行改写，若为打招呼、结束语等无需改写。直接输出无需改写2.改写后的query不能发生语义和者意图改变3.结合对话历史上下文，对query进行完善和补全，补全缺失的主体（人物、组织等）和情景（地点、时间和事件等等）4.信息增量确保在合适的范围，不要增添过于冗余的信息--输出格式--直接输出改写后的query。若不需改写，直接输出原始query。--示例输入与输出--示例1##对话历史：Q：介绍一下XX公司A：XX公司是一家成立于2018年的AI虚拟人公司...输入：招人吗输出：XX公司还在招聘吗？示例2##对话历史：Q：公司周边有什么餐厅吗A：是的，公司附近有很多美食餐厅，包括...输入：外卖可以吗？输出：请问公司周边的餐厅可以点外卖吗？--输入--##对话历史{}输入：{}输出：|
...
|1   |个人中心五、权益管理2. 当前权益* 言币权益\\支持查看当前言币/全部言币剩余，包括加购剩余、活动剩余、套餐剩余、当前总剩余言币。\\                                                                                        |chunk-1      |[0.1245, 0.3677, 0.9021, 0.3019, 0.4394, 0.0714, 0.4484, 0.5045]|个人中心五、权益管理2. 当前权益* 言币权益\\支持查看当前言币/全部言币剩余，包括加购剩余、活动剩余、套餐剩余、当前总剩余言币。\\进入【权益管理】界面，点击“当前言币/全部言币”，单击即可。\\查看详情\\支持查看当前言币/全部言币，包括类型、总言币、消耗言币、剩余言币、生效时间、失效时间。\\进入【权益管理】界面，选择“当前言币/全部言币”>“查看详情”。|
|2   |进入【权益管理】界面，点击“当前言币/全部言币”，单击即可。\\查看详情\\支持查看当前言币/全部言币，包括类型、总言币、消耗言币、剩余言币、生效时间、失效时间。\\进入【权益管理】界面，选择“当前言币/全部言币”>“查看详情”。|chunk-2      |[0.4544, 0.0079, 0.6594, 0.7154, 0.5299, 0.8568, 0.5065, 0.6144]|                                                                                                                                                                                                                                                                                                                                                    |
|3   |如何查看言币权益                                                                                                                                                                                                      |摘要         |[0.1744, 0.9765, 0.9498, 0.9731, 0.5622, 0.4062, 0.4986, 0.0459]|                                                                                                                                                                                                                                                                                                                                                    |
|4   |查看言币的使用情况                                                                                                                                                                                                    |摘要         |[0.1245, 0.3677, 0.9021, 0.3019, 0.4394, 0.0714, 0.4484, 0.5045]|                                                                                                                                                                                                                                                                                                                                                    |
